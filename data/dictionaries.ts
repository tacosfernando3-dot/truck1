...
export const dictionaries = {
  en: {
    ...
    hero: {
      eyebrow: "Gourmet street food",
      titleLine1: "BOLD FLAVOR.",
      titleLine2: "ANYWHERE.",
      subtitle: "Gourmet street food made fresh and served with passion.",
      viewMenu: "View Menu",
      findUs: "Find Us",
    ...
    locationsPage: {
      ...
      mapTitle: "Map of today's Street Flavor stop — {neighborhood}",
    },
    about: {
      eyebrow: "About",
    ...
    catering: {
      ...
      subtitle:
        "From rooftop birthdays to production craft services, Street Flavor rolls up with a tight crew, a customizable menu, and lines that actually move.",
      packages: "Packages",
      packagesIntro:
  ...
  es: {
    ...
    locationsPage: {
      ...
      mapTitle: "Mapa de la parada de hoy de Street Flavor — {neighborhood}",
    },
    about: {
      eyebrow: "Nosotros",
    ...
    catering: {
      ...
      subtitle:
        "Desde cumpleaños en azoteas hasta craft services de producción, Street Flavor llega con un equipo ágil, menú personalizable y filas que sí avanzan.",
      packages: "Paquetes",
      packagesIntro:
